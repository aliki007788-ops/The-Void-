...
def create_certificate(user_id, burden, photo_path=None):
    img = Image.new('RGB', (1000, 1000), color='#000000')
    ...
    if photo_path and os.path.exists(photo_path):
        try:
            ...
            # حاشیه طلایی دور عکس
            draw.ellipse((355, 75, 645, 365), outline='#FFD700', width=5)

            y_text_start = 480  # متن‌ها پایین‌تر بره
    ...
    draw.text((500, y_text_start + 100), "THIS SACRIFICE IS REGISTERED", fill="#888888", font=font_sub, anchor="mm")
    draw.text((500, y_text_start + 180), f"\"{burden.upper()}\"", fill="#FFFFFF", font=font_main, anchor="mm")
    draw.text((500, y_text_start + 280), "IN THE ETERNAL VOID", fill="#888888", font=font_sub, anchor="mm")
    draw.text((500, 900), f"HOLDER: {user_id} | 2025.VO-ID", fill="#555555", font=font_sub, anchor="mm")
